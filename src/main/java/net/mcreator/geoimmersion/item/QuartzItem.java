...
public class QuartzItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent(
				"A crystalline mineral made of silica, member of the tectossilicates. The second most abundant mineral in Earth\uFFFDs continental crust. Can be used to craft Quartz Sandpaper."));
	}
}
