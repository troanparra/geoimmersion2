...
public class GarnetItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent(
				"Garnet is a large group of rock-forming minerals with common crystal structure. They can be found in metamorphic, igneous and sedimentary rocks. Can be used to craft Garnet Sandpaper."));
	}
}
