...
public class CarbideItem extends Item {
	public CarbideItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Generally a compound composed of both carbon and a metal. Is useful to refuel the Miner\uFFFDs Helmet."));
	}
}
