...
public class VanadiniteItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent(
				"Rare mineral from the apatite subgroup. Source mineral of vanadium but also, in some occasions, of lead. When smelted with a blast furnace it gives one Vanadium nugget."));
	}
}
