...
public class OillakeFeature extends Feature<NoneFeatureConfiguration> {
	public static OillakeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new OillakeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("geoimmersion:oillake", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("geoimmersion:oillake", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public OillakeFeature() {
		...
		base_blocks = List.of(GeoimmersionModBlocks.METASANDSTONE.get(), GeoimmersionModBlocks.METALIMESTONE.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("geoimmersion", "oil_lake"));
		if (template == null)
			return false;
