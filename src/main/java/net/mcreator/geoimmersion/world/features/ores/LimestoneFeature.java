...
public class LimestoneFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("geoimmersion:limestone", FEATURE,
				new OreConfiguration(LimestoneFeatureRuleTest.INSTANCE, GeoimmersionModBlocks.LIMESTONE.get().defaultBlockState(), 64));
		PLACED_FEATURE = PlacementUtils.register("geoimmersion:limestone", CONFIGURED_FEATURE,
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("sunflower_plains"),
			...
			new ResourceLocation("jungle"), new ResourceLocation("swamp"));
	...
	private static class LimestoneFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("geoimmersion:limestone_match"), CUSTOM_MATCH);
		}
