...
public class VolcanicterrainLeaveDecorator extends LeaveVineDecorator {
	public static final VolcanicterrainLeaveDecorator INSTANCE = new VolcanicterrainLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("volcanicterrain_tree_leave_decorator");
