...
public class TravertinetrapFeature extends Feature<NoneFeatureConfiguration> {
	public static TravertinetrapFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TravertinetrapFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("geoimmersion:travertinetrap", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("geoimmersion:travertinetrap", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TravertinetrapFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(Blocks.CAVE_AIR, GeoimmersionModBlocks.TRAVERTINE.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("geoimmersion", "travertine_trap2"));
		if (template == null)
			return false;
