...
public class MetalimestoneBlock extends Block {
	public MetalimestoneBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Limestone that has been under the effect of metamorphic processes."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Metalimestone"));
		list.add(new TextComponent("Uncommon - Charcoal"));
		list.add(new TextComponent("Rare - Trilobite, Fluorite"));
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GeoimmersionModBlocks.METALIMESTONE.get()));
	}
}
