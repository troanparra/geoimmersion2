...
public class QuartizitewithSilverBlock extends Block {
	public QuartizitewithSilverBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of Silver in Quartzite."));
		list.add(new TextComponent("When broken it can only drop the block itself."));
	}
