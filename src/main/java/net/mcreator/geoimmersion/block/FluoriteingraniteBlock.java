...
public class FluoriteingraniteBlock extends Block {
	public FluoriteingraniteBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GeoimmersionModItems.FLUORITE.get()));
	}
}
