...
public class SchistBlock extends Block {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Schist is a medium-grade metamorphic rock that has been formed from shale or mudstone."));
		...
		list.add(new TextComponent("Uncommon - Garnet, Tourmaline, Horneblende, Magnetite"));
	}
