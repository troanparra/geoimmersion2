...
public class ApatiteinGraniteBlock extends Block {
	public ApatiteinGraniteBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GeoimmersionModItems.APATITE.get()));
	}
}
