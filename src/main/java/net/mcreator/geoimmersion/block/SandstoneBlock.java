...
public class SandstoneBlock extends Block {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Sandstone is a sedimentary rock composed of sand-sized minerals, organic material or rock."));
		list.add(new TextComponent("One of the most common types of sedimentary rocks."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Sandstone"));
