...
public class CopperinGabroBlock extends Block {
	public CopperinGabroBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurence of Copper in Gabbro."));
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GeoimmersionModBlocks.COPPERIN_GABRO.get()));
	}
