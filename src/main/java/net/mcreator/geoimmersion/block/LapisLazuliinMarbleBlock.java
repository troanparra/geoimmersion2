...
public class LapisLazuliinMarbleBlock extends Block {
	public LapisLazuliinMarbleBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurence of Lapis Lazuli in Marble."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Lapis Lazuli"));
		list.add(new TextComponent("Uncommon - Tourmaline"));
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(Items.LAPIS_LAZULI, 6));
	}
