...
public class QuartizitewithgolddustBlock extends Block {
	public QuartizitewithgolddustBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of gold dust in Quartzite."));
