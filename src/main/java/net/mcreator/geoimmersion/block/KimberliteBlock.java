...
public class KimberliteBlock extends Block {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Kimberlite is an igneous rock that can sometimes contain diamonds."));
		list.add(new TextComponent("It is named after the city of Kimberly, in South Africa."));
		...
		list.add(new TextComponent("Rare - Diamond"));
	}
