...
public class EmeraldinGnaisseBlock extends Block {
	public EmeraldinGnaisseBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of Emerald in Gneiss."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Quartz, Biotite, Feldspar, Emerald, Magnetite"));
		list.add(new TextComponent("Uncommon - Tourmaline, Garnet, \tRare - Wolframite"));
	}
