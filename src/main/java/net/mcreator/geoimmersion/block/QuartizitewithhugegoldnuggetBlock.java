...
public class QuartizitewithhugegoldnuggetBlock extends Block {
	public QuartizitewithhugegoldnuggetBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurence of a gold vein in Quartzite."));
		...
		list.add(new TextComponent("Rutile"));
	}
