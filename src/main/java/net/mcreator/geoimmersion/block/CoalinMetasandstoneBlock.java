...
public class CoalinMetasandstoneBlock extends Block {
	public CoalinMetasandstoneBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of Metasandstone with Coal."));
