...
public class QuartizitewithgoldnuggetsBlock extends Block {
	public QuartizitewithgoldnuggetsBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of gold nuggets in Quartzite."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Gold Nugget"));
		list.add(new TextComponent("Uncommon - Nether Quartz, Rutile"));
	}
