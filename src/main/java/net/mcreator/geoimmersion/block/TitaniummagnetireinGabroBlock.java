...
public class TitaniummagnetireinGabroBlock extends Block {
	public TitaniummagnetireinGabroBlock() {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Natural occurrence of Titanium in Gabbro."));
		list.add(new TextComponent("When broken with the Geologist\uFFFDs Hammer, it has the following possible drops:"));
		list.add(new TextComponent("Common - Feldspar, Olivine, Magnetite"));
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GeoimmersionModBlocks.TITANIUMMAGNETIREIN_GABRO.get()));
	}
