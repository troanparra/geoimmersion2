...
public class GeofurnaceBIFrecipeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 1)).getItem() == GeoimmersionModBlocks.BANDED_IRON_FORMATION.get().asItem() && (new Object() {
			...
			if (Math.random() < 0.25) {
				{
					...
					if (_ent != null) {
						final int _slotid = 3;
						final ItemStack _setstack = new ItemStack(GeoimmersionModItems.SLAG.get());
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
