...
public class CentrifugueFuelProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == GeoimmersionModItems.FILLEDOILBARREL.get()) {
			if (!world.isClientSide()) {
				BlockPos _bp = new BlockPos(x, y, z);
				BlockEntity _blockEntity = world.getBlockEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getTileData().putDouble("burnTime", 10000);
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 2;
					final ItemStack _setstack = new ItemStack(GeoimmersionModItems.OILBARREL.get());
